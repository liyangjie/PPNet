...
parser.add_argument('-t2','--ANC_threshold',default = 'auto',
                    help='The threshold of |1-ANC| [0-0.999], or set as "auto" to select the inflection point as the threshold for |1-ANC|. (Default "auto")')
...
def main():
    ...
    if args.ANC_threshold =='auto':
        ...
        anc_Threshold = args.ANC_threshold
